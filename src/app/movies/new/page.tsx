...
const movieSchema = z.object({
  ...
  url: z.string().min(1, 'Movie/Video URL is required').url('Invalid video URL'),
  trailer_url: z.string().min(1, 'Trailer URL is required').url('Invalid trailer URL'),
  movie_image: z.string().min(1, 'Poster Image is required').url('Invalid poster image URL'),
  card_image: z.string().min(1, 'Card Image is required').url('Invalid card image URL'),
                  ...
                  <div key={field.id} className="p-4 bg-muted/30 border border-border rounded-xl space-y-4 relative group">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          type="button"
                          onClick={() => document.getElementById(`subtitle-upload-new-${index}`)?.click()}
